...
```{r}
tidbit.files <- list.files(path="2023/data/environmental/logger", pattern="*27.csv", full.names=TRUE)
...
```{r}
u22.files <- list.files(path="2023/data/environmental/logger", pattern="*30.csv", full.names=TRUE)
...
```{r}
metadata <- read.csv("2023/data/environmental/logger_meta.csv")
...
# Save plot 
ggsave("2023/figures/environmental/logger_temperature_smooth.png", temp_plot_treatment1, width=6, height=4)
```
